...
local BLOCKED_OUTPUT_PATTERNS = {
    ...
    -- followed by a dot; we match the canonical NTKÃ¢â‚¬Â¦. prefix shape)
...
local t = {
    ...
    deobf_attempts = 0,
    emit_count = 0,
    -- Loop detection: map of "source:line" Ã¢â€ â€™ hit count and seen flags
    loop_line_counts = {},
    loop_detected_lines = {},
...
local function I(J)
    ...
    local function Q(R)
        ...
        R = R:gsub("!==", "~=")          -- JS strict not-equal  Ã¢â€ â€™  Lua not-equal
        R = R:gsub("!=",  "~=")          -- JS not-equal         Ã¢â€ â€™  Lua not-equal
        R = R:gsub("%s*&&%s*", " and ")  -- JS/C logical AND      Ã¢â€ â€™  Lua and
        R = R:gsub("%s*||%s*", " or ")   -- JS/C logical OR       Ã¢â€ â€™  Lua or
        -- Power operator ** (Python / JS) Ã¢â€ â€™ ^ (Lua).
        -- Must run before compound-assignment expansion so that e.g. x**=2 gets
        -- properly rewritten: **= Ã¢â€ â€™ ^= which is then expanded by the V table.
        R = R:gsub("%*%*=", "^=")         -- **= Ã¢â€ â€™ ^=  (then expanded below)
        R = R:gsub("%*%*",  "^")         -- **  Ã¢â€ â€™ ^
        local V = {{"+=", "+"}, {"-=", "-"}, {"*=", "*"}, {"/=", "/"}, {"%%=", "%%"}, {"%^=", "^"}, {"%.%.=", ".."}}
        ...
        -- null / undefined Ã¢â€ â€™ nil (word-boundary safe: require non-identifier context)
        for _, _kw in ipairs({"null", "undefined"}) do
            R = R:gsub("([^%w_])" .. _kw .. "([^%w_])", "%1nil%2")
            R = R:gsub("^"       .. _kw .. "([^%w_])",  "nil%1")
            R = R:gsub("([^%w_])" .. _kw .. "$",        "%1nil")
        end
        -- else if Ã¢â€ â€™ elseif (Lua requires a single keyword; only collapse when
...
local function at(O, au)
    ...
    if t.rep_n > 0 then
        ...
        if aw == expected then
            ...
            -- Cycle broken Ã¢â‚¬â€œ fall through to normal emit + fresh cycle scan below.
            t.rep_n    = 0
            t.rep_full = 0
            t.rep_pos  = 0
        end
...
local function aP(aQ, aR, aS)
    ...
    -- "get3" style names Ã¢â‚¬â€ fall back to "var" so the deduplicator can assign a
...
local function aW(x, aQ, aX, aS)
    ...
    -- letter so "ScreenGui" Ã¢â€ â€™ "screenGui", "Frame" Ã¢â€ â€™ "frame", etc.
...
bk = function(aS, bw)
    ...
    bi.__call = function(self, bz, ...)
        ...
        -- If the method is a generic verb (Get, Add, Create, Ã¢â‚¬Â¦) with no library-prefix
        -- override, try to use the first plain-string argument as the proxy name so
        -- the dump reads  "local config = obj:GetConfig()"  rather than "local get2 = Ã¢â‚¬Â¦"
...
bj = function(aQ, bO, bw)
    ...
    bP.GetPlayerFromCharacter = function(self, ck)
        -- eUNC passes a plain {} table Ã¢â‚¬â€ should return nil, not a proxy
...
-- EmulaciÃƒÂ³n bÃƒÂ¡sica de bitwise para Lua 5.1
...
_G.Random = Random
_G.Instance = Instance
-- Ã¢â€â‚¬Ã¢â€â‚¬ Standard Lua globals that scripts may rely on Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
_G._VERSION = "Luau"
...
-- Ã¢â€â‚¬Ã¢â€â‚¬ Luau table extensions Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
_G.table = table
-- Ã¢â€â‚¬Ã¢â€â‚¬ Luau math extensions Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
_G.math = math
-- Ã¢â€â‚¬Ã¢â€â‚¬ Luau string extensions Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
-- Ã¢â€â‚¬Ã¢â€â‚¬ string.char / table.concat interception Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
_G.string = string
_G.table = table
-- Ã¢â€â‚¬Ã¢â€â‚¬ Luau buffer library stub Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
if not buffer then
    buffer = {
...
_G.buffer = buffer
-- Ã¢â€â‚¬Ã¢â€â‚¬ Extra coroutine stubs (Lua 5.4 / Luau) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
_G.coroutine = coroutine
-- Ã¢â€â‚¬Ã¢â€â‚¬ Luau-specific exec globals Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
-- Ã¢â€â‚¬Ã¢â€â‚¬ Roblox service globals (anti-tamper: scripts may query these directly) Ã¢â€â‚¬Ã¢â€â‚¬
do
...
local GEN_VM_BOUNDARIES = {
    ...
    -- Generic long-argument dispatcher heuristic: Ã¢â€°Â¥8 consecutive single-letter
...
local GEN_STRING_VARS = {
    ...
    "t",    -- generic / Iron Brew
    "args",
    -- Single letters aÃ¢â‚¬â€œz (excluding w, t, S already listed above)
...
local function generic_wrapper_extract_strings(source_code)
    ...
    for _, vm_pat in ipairs(GEN_VM_BOUNDARIES) do
        ...
        if boundary then
            ...
            -- 3. For each candidate string table variable name Ã¢â‚¬Â¦
            for _, var_name in ipairs(GEN_STRING_VARS) do
                -- 4. Ã¢â‚¬Â¦ try each nesting depth (1 = standard, 2-4 = nested wrappers).
...
local function xor_extract_strings(source_code)
    ...
    -- Find the name of the first `local function` in the file Ã¢â‚¬â€ this is the
...
local function lightcate_extract_strings(source_code)
    ...
    -- Strategy 2: Fallback Ã¢â‚¬â€ find the last local _0x-named variable in the preamble.
    if not str_var then
...
-- (e.g.  local k0 = v0 Ã¢â‚¬Â¦ local k250 = v250) and converts the overflow
...
_reduce_locals = function(src)
    ...
    if best then
        ...
        -- Replace all references to overflow variable names (e.g. k180 Ã¢â€ â€™ _catExt[1])
    ...
    -- NOT rewritten here Ã¢â‚¬â€œ instead each chunk keeps its own small table with a
    -- unique suffix (_catExt2, _catExt3, Ã¢â‚¬Â¦).  This is safe only when the overflow
...
function q.dump_file(eN, eO)
    ...
    if xor_strings and #xor_strings > 0 then
        B(string.format("[Dumper] XOR obfuscation detected (fn=%s) Ã¢â‚¬â€ %d strings decrypted", tostring(xor_fn), #xor_strings))
    ...
    if gw_strings and #gw_strings > 0 then
        B(string.format("[Dumper] %s wrapper detected (var=%s) Ã¢â‚¬â€ %d/%d strings decoded",
    ...
    if lc_strings and #lc_strings > 0 then
        B(string.format("[Dumper] Lightcate v2.0.0 wrapper detected (var=%s) Ã¢â‚¬â€ %d/%d strings decoded",
    ...
    if prom_strings and #prom_strings > 0 then
        B(string.format("[Dumper] Prometheus obfuscation detected (var=%s) Ã¢â‚¬â€ %d/%d strings decoded",
    ...
    do
        ...
        rawset(eR, "crypt", {
            ...
            encrypt        = function(s, key, iv, mode)
                -- XOR cipher stub Ã¢â‚¬â€ reversible for round-trip tests
    ...
    do
        local _vfs_files   = {}   -- path Ã¢â€ â€™ content string
        local _vfs_folders = {}   -- path Ã¢â€ â€™ true
...
function q.dump_string(al, eO)
    ...
    if al then
        ...
        local xor_strings, xor_fn = xor_extract_strings(al)
        if xor_strings and #xor_strings > 0 then
            B(string.format("[Dumper] XOR obfuscation detected (fn=%s) Ã¢â‚¬â€ %d strings decrypted", m(xor_fn), #xor_strings))
            t.xor_string_pool = { strings = xor_strings }
        else
            t.xor_string_pool = nil
        end
